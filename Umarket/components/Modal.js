  ...
  return ReactDom.createPortal(
    <div className='fixed inset-0 bg-white text-red-900 text-lg sm:text-xl flex flex-col'>
      ...
      <div className='p-4 flex flex-col gap-3'>
        <h2 onClick={handleLogout} className='select-none duration-300 hover:pl-2 hover:text-yellow-500 cursor-pointer'>
      ...
      {currentUser &&(<div className='p-4 flex flex-col gap-3'>
        <h2
          onClick={()=> {
            ...
            setOpenModal(false)}}
          className='select-none duration-300 hover:pl-2 hover:text-yellow-500 cursor-pointer'
        >
          UserDashboard
        </h2>
      </div>
